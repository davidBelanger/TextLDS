%%NOTE: this is the same as solvric.m, except that you pass it an MIL struct for
%%inv(L0) directly rather than inverting L0 when you get it. This is useful
%%for structured L0 (e.g. diag + low rank).

%
% [P,flag] = solvricLR(A,G,C,invL0)
%
% Description:
...
function [P,flag] = solvricLR(A,G,C,L0i)
...
AA = [A'-MIL_innerMultiply(L0i,C',G') zeros(n,n);-MIL_innerMultiply(L0i,G,G') eye(n)];
BB = [eye(n) -MIL_innerMultiply(L0i,C',C);zeros(n,n) A-MIL_innerMultiply(L0i,G,C)];
